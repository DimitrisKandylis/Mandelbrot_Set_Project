...
Partial Class Form6
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "If you have selected the 'Mandelbrot Set' Radiobutton and " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "have created the whol" & _
    "e Set, you have the ability to freeroam" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "and zoom around the set. The controls a" & _
    "re:"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Up Arrow Key = Go Up"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "Down Arrow Key = Go Down"
        '
        'Label4
        '
        ...
        Me.Label4.Text = "Left Arrow Key = Go Left"
        '
        'Label5
        '
        ...
        Me.Label5.Text = "Right Arrow Key = Go Right"
        '
        'Label6
        '
        ...
        Me.Label7.Text = "F2 = Zoom Out"
        '
        'Button1
        '
        Me.Button1.Location = New System.Drawing.Point(128, 186)
